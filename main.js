var sketchProc = function(processingInstance) {
  ...
  var App = (function() {
      var App = function() {
          ...
          this.sound = false;
          this.sounds = {
            lava: this.addSound("https://www.kasandbox.org/programming-sounds/rpg/water-bubble.mp3"),
            bird: this.addSound("https://www.kasandbox.org/programming-sounds/rpg/giant-yah.mp3"),
            spike: this.addSound("https://www.kasandbox.org/programming-sounds/rpg/giant-hyah.mp3"),
            wall: this.addSound("https://www.kasandbox.org/programming-sounds/rpg/hit-thud.mp3"),
            lazer: this.addSound("https://www.kasandbox.org/programming-sounds/retro/laser2.mp3"),
      ...
      App.prototype = {
          ...
          runFishes: function() {
              ...
              for(var i = 0; i < this.fishes.length; i++) {
                  ...
                  pushMatrix();
                      ...
                      triangle(-fish.diameter * 0.4, 0, -fish.diameter * 0.7, -fish.diameter * 0.3, -fish.diameter * 0.7, fish.diameter * 0.3);
                  popMatrix();
                  
                  fish.x+= fish.vx * fish.dir;
                  
                  //if fish go off the screen then reset them
                  if( (fish.dir === 1 && fish.x - fish.diameter > width)  || 
                  ...
                  for(var i = this.blocks.length - 1; i >= 0; i--) {
                      ...
                      if(block.y > this.player.ymin + 400) {
                          ...
                          if(dist(b1.x + b1.w, b1.y, b2.x, b2.y) > 200) {
                              ...
                              else if(selection < 0.85 && b1.h > 150) { //enemy
                                  var dir = random() < 0.5 ? 1 : -1;
                                  this.enemies.push({
              ...
              pushStyle();
                  ...
                  for(var i = this.stars.length - 1; i >= 0; i--) {
                      ...
                      pushMatrix();
                          ...
                          image(star.image, 0, 0, star.diameter * 1.5, star.diameter * 1.5);
                      popMatrix();
          ...
          updateParallax: function() {
              ...
              if(this.parallax.back.y1 + this.cam.y >= this.images.back.height) {
                  this.parallax.back.y1 = this.parallax.back.y2 - this.images.back.height;
              }
              if(this.parallax.back.y2 + this.cam.y >= this.images.back.height) {
          ...
          leaderboard: function() {
              ...
              pushStyle();
                  ...
                  for(var i = 0; i < this.highscores.length; i++) {
                      ...
                      text(this.highscores[i].score, width / 2 + 50, 110 + i * 35);
                  }
              popStyle();
